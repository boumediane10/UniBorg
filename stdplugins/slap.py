...
SLAP_TEMPLATES = [
    ...
    "sent {user2} to /dev/null.",
    "sent  {user2} down the memory hole.",
    "beheaded  {user2}.",
    "threw  {user2} off a building.",
    "replaced all of  {user2}\'s music with Nickelback.",
    "spammed  {user2}\'s email.",
    "made  {user2} a knuckle sandwich.",
    "slapped  {user2} with pure nothing.",
    "{user1} hit {user2} with a small, interstellar spaceship.",
    "quickscoped {user2}.",
    "put {user2} in check-mate.",
    "RSA-encrypted  {user2} and deleted the private key.",
    "put {user2} in the friendzone.",
    "slaps {user2} with a DMCA takedown request!"
]
